...
%% mdlInitializeSizes
    ...
    set_param(blocks{1},'DelayTime', num2str(te));
...
function sys=mdlOutputs(~,sx,u)
    ...
    switch controllerTypeK
        case {54,56}
            ...
            Ips_poE = [sx(5);sx(6)];
            Psisf = gm*Psis-gm^2*En*IPsisE;
            pf = gm*(ps-Idpo)-gm^2*En*Ips_poE;
            if t<Te
    ...
    switch controllerTypeK
        ...
        case {56}
            ...
            alpha_ex = DirectPPC_amplifier(ex,rou_ex,delta_ex,alpha,xi_ex_p,amplifierType);
            xi_ex = alpha_ex*ex;
            [mu_ex,upsilon_ex] = DirectPPC_amplifier_derivative(ex,rou_ex,drou_ex,delta_ex,alpha,xi_ex_p,amplifierType);
            xi_ey_p = 1;
            delta_ey = 0.1;
            rou_ey = PPC_rho_inf(t,T,epsilon_ey,xi_ey_p,0);
            drou_ey = PPC_rho_inf_derivative(t,T,epsilon_ey,xi_ey_p,0);
            alpha_ey = DirectPPC_amplifier(ey,rou_ey,delta_ey,alpha,xi_ey_p,amplifierType);
            xi_ey = alpha_ey*ey;
            [mu_ey,upsilon_ey] = DirectPPC_amplifier_derivative(ey,rou_ey,drou_ey,delta_ey,alpha,xi_ey_p,amplifierType);
    end
